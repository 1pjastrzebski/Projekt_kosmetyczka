        ...
        <form action="php/log.php" method="post" class="p-4 rounded">
            ...
            <div>
                ...
                if (isset($_SESSION["log_err"])) {
                    echo "<p id='log_err' class='form-error-text'>" . $_SESSION["log_err"] . "</p>";
                    unset($_SESSION["log_err"]);
                }
                ?>
            </div>
            <div>
                <p>Nie masz jeszcze konta? <a href="sing-form.php">Stwórz konto</a></p>
            </div>
            <div class="d-flex justify-content-center">
                <button class="btn fs-5" type="submit">Zaloguj się</button>
            </div>
        </form>
    </div>
